...
const journey: JourneyChapter[] = [
...

  {
    ...
    /*
      For your blurred Holi photo we want the image to
      fill the story card rather than leaving empty space.
    */
    imageFit: "contain",
...

  {
    ...
    paragraphs: [
      "My next major step was joining Swire Coca-Cola as a Data Engineering Intern. That opportunity helped turn what I had been learning into real engineering and analytics work, and it eventually led to a full-time role as a Business Intelligence Analyst.",

      "I worked across data pipelines, SQL, Python, cloud platforms, Snowflake, Power BI, automation, operational analytics, and data modernization. But my growth there was not limited to the technical side. I became involved in broader enterprise initiatives and spent time understanding how the business actually operated, not just how the data looked on a screen.",

      "I made it a practice to learn the business through direct observation and conversations with the people doing the work. That included ride-alongs, site visits, and spending time with operational teams to understand their workflows, challenges, and decision-making processes. This helped me connect technical solutions to real business needs and earned strong appreciation from stakeholders for taking the initiative to understand their world before proposing solutions.",

      "This chapter taught me that the best data solutions are not necessarily the most complicated ones. They are the ones that people can trust, understand, and actually use to make better decisions.",
    ],
  },
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1650px] items-center justify-between px-6 py-5 lg:px-16">
          <a
            href="/"
            className="text-base font-semibold text-gray-300 transition hover:text-cyan-300 md:text-lg"
          >
            ← Abhilash Portfolio
          </a>
      ...
      <section className="relative overflow-hidden px-6 pb-24 pt-20 lg:px-16">
        ...
        <div className="relative mx-auto grid w-full max-w-[1650px] items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          {/* LEFT */}
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-3xl bg-gradient-to-r from-blue-400 via-cyan-300 to-white bg-clip-text text-5xl font-bold leading-[1.05] text-transparent md:text-6xl xl:text-7xl">
        ...
        <div className="relative mx-auto mt-16 w-full max-w-[1650px]">
          <div className="mb-5 text-xs font-semibold uppercase tracking-[0.22em] text-cyan-400">
            THE PATH SO FAR
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {careerPath.map((item, index) => (
              <div
                key={item.name}
                className="group relative overflow-hidden rounded-2xl border border-blue-400/15 bg-slate-900/40 p-4 backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-cyan-400/35"
              >
                <div className="absolute right-4 top-3 text-4xl font-bold text-blue-500/10">
                ...
                <div className="relative">
                  {item.logo ? (
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-cyan-400/20 bg-cyan-500/5 text-sm font-bold text-cyan-300">
                      {index + 1}
                    </div>
                  )}
      ...
      <section className="px-6 py-24 lg:px-16">
        <div className="mx-auto w-full max-w-[1500px] space-y-32">
          {journey.map((chapter, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={
                    hasVisual && index % 2 === 1 ? "lg:order-2" : ""
                  }
                >
                  ...
                  <div className="mt-7 space-y-5">
                    {chapter.paragraphs.map((paragraph) => (
                      <p
                        key={paragraph}
                        className="text-[15px] leading-8 text-gray-400 md:text-base"
                      >
                        {paragraph}
                      </p>
                    ))}
                ...
                {hasImage && chapter.image && (
                  <div
                    className={index % 2 === 1 ? "lg:order-1" : ""}
                  >
                    <div className="grid gap-4">
                      <div className="overflow-hidden rounded-3xl border border-blue-400/20 bg-slate-900/50 p-2">
                        <div className="relative h-[390px] overflow-hidden rounded-[1.25rem] bg-slate-950/60 md:h-[430px] xl:h-[450px]">
                          <img
                            src={chapter.image}
                            alt={chapter.imageAlt ?? chapter.title}
                            className="h-full w-full"
                            style={{
                              objectFit: chapter.imageFit ?? "cover",
                              objectPosition:
      ...
      <section className="border-y border-white/5 bg-slate-900/20 px-6 py-24 lg:px-16">
        <div className="mx-auto w-full max-w-[1500px]">
          <div className="text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-cyan-400">
